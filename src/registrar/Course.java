...
public class Course {
    ...
    //updates the roster after changes have been made to enrollmentLimit
    //adding waitlisted students to the roster
    private void updatedRoster() {
        while (!(this.isFull())&&(!(this.waitlist.isEmpty()))) {
